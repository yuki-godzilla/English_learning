...
- **Pronunciation — 今回はN/A**：Session 9は直接音声を評価していない。最後に直接確認したのは[Session 8](#session-2026-08-27-01)で、全体の明瞭さはL3だった。
...
Session 9で更新した会話・口頭対話の目安は、TOEIC Speaking **140–160 / 200**、IELTS Speaking **Band 5.5–6.5**、TOEFL iBT Speaking **3.5–4.0 / 6**、CEFR会話 **B1+–B2**。いずれも公式形式の試験結果ではなく、会話記録に基づく学習計画用のレンジです。根拠と全種別は[Session 9の評価](#session-2026-08-28-01)で確認できます。
